package com.nikhil.springbootmicroservicecurrencyconversion.controller;

import com.nikhil.springbootmicroservicecurrencyconversion.model.CurrencyConversionBean;
import com.nikhil.springbootmicroservicecurrencyconversion.proxy.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversionBean convertCurrency(@PathVariable String from,
        ...
        System.out.println("from --> "+uriVariables.get("from") + " to -->"+ uriVariables.get("to"));
